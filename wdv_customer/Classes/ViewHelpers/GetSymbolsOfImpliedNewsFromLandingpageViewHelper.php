 ...
 ***************************************************************/
/**
 * Class GetSymbolsOfImpliedNewsFromLandingpageViewHelper
 * @package WDV\WdvCustomer\ViewHelpers
 */
use WDV\WdvCustomer\Domain\Model\NewsLandingpage;
...
class GetSymbolsOfImpliedNewsFromLandingpageViewHelper extends AbstractViewHelper
{
	/**
 ...
 public function initializeArguments(): void
	{
		...
		$this->registerArgument('news', NewsLandingpage::class, 'news item');
	}
	...
	public static function renderStatic(
		...
		if($news) {
			...
			foreach($news->getTxWdvcustomerLandingpageImpliedNews() as $impliedNews) {
