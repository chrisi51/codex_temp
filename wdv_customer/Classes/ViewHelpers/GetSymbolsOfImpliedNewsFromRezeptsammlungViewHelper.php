 ...
 */
use WDV\WdvCustomer\Domain\Model\NewsRezeptSammlung;
...
class GetSymbolsOfImpliedNewsFromRezeptsammlungViewHelper extends AbstractViewHelper
{
 ...
 public function initializeArguments(): void
	{
		...
		$this->registerArgument('news', NewsRezeptSammlung::class, 'news item');
	}
	...
	public static function renderStatic(
		...
		if($news) {
			...
			foreach($news->getTxWdvcustomerRezeptsammlungImpliedNews() as $impliedNews) {
